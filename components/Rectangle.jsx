  ...
  return (
    <>
      <motion.div
        ...
        animate="animate"
        exit="exit"
        transition={{ delay: 0, duration: 0.25, ease: [0.63, 0, 0.17, 1] }}
      ...
      <motion.div
        ...
        animate="animate"
        exit="exit"
        transition={{ delay: 0.1, duration: 0.35, ease: [0.63, 0, 0.17, 1] }}
      ...
      <motion.div
        ...
        animate="animate"
        exit="exit"
        transition={{ delay: 0.2, duration: 0.45, ease: [0.63, 0, 0.17, 1] }}
