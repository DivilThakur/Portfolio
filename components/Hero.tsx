...
const Hero = () => {
  return (
    <div className='pb-20 pt-36 relative '>
      ...
      <div className='flex justify-between absolute left-0 right-0 -bottom-12  lg:-bottom-12 z-50 '>
        <div className='h-56 text-5xl '>
          <TextHoverEffect
            text='Divil'
          />
        </div>
      ...
      <div className='flex justify-center relative my-20 z-10 '>
        <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center '>
          <h2 className='uppercase tracking-widest text-xs text-center text-blue-100 max-w-80'>
            ...
            <FlipWords
              words={["Next.js", "React.js", "Tailwind CSS", "Aceternity UI"]}
              duration={2000}
          ...
          <p className='text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl text-white-100'>
            Hi, I&apos;m Divil, a Full-Stack Developer
          </p>
